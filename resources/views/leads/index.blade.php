        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="me-3">
                        <a href="{{ route('leads.create') }}" class="btn rounded-pill btn-primary">
                            <span class="tf-icons bx bx-message-square-add"></span>&nbsp; Create Contact
                        </a>
                    </div>
                </div>
                        ...
                        <tbody>
                            @foreach ($contacts as $contact)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('leads.show', $contact->id) }}"
                                            class="btn btn-info btn-sm">View</a>
                                        <a href="{{ route('leads.edit', $contact->id) }}"
