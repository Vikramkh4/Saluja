...
class LeadController extends Controller
{
    ...
    {
        // Retrieve only contacts where type is 'Lead'
        $contacts = Contact::where('type', 'Lead')->get();
        return view('leads.index', compact('contacts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('leads.index')->with('success', 'Contact created successfully');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('leads.show', compact('contact'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $contact=Contact::findOrFail($id);
        //    dd($contact);
            return view('leads.edit',compact('contact'));
    }
    ...
    public function destroy(string $id)
    {
        ...
        $contact=Contact::findOrFail($id);
        $contact->delete();
        return  redirect()->route('leads.index')->with('success','Contact deleted successfully');
