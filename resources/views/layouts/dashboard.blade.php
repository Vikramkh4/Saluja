            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{ url('/') }}" class="app-brand-link d-flex align-items-center">
                        <img src="{{ asset('/assets/img/favicon/logo1.png') }}" alt="Logo"
                            class="app-brand-logo demo" style="max-width: 100%; height: auto; width: 100px;">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('proposals.pip') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-notepad"></i>
                            <div data-i18n="Proposals">Pipeline</div>
                        </a>
                    </li>
                    <li class="menu-item">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('contacts.index') }}" class="menu-link">
                            ...
                            <div data-i18n="Contacts">All Contacts</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('leads.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bxs-contact"></i>
                            <div data-i18n="Leads">All leads</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('customers.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bxs-contact"></i>
                            <div data-i18n="Customers">All Customers</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item">
                        <a href="{{ route('feeds.create') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bxs-contact"></i>
                            <div data-i18n="Customers">feedback</div>
                        </a>
                    </li>
                    <li class="menu-item">
