...
class CustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('customer.index')->with('success', 'Contact created successfully');
    }
    /**
    ...
    public function show(string $id)
    {
        ...
        return view('customer.show', compact('contact'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $contact=Contact::findOrFail($id);
    //    dd($contact);
        return view('customer.edit',compact('contact'));
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('customer.index')->with('success', 'Contact updated successfully!');
    }
    ...
    public function destroy(string $id)
    {
        $contact=Contact::findOrFail($id);
        $contact->delete();
        return  redirect()->route('customer.index')->with('success','Contact deleted successfully');
